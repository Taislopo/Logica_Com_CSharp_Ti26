...
namespace Notas_de_dinheiro
{
    internal class Program
    {
        static void Main(string[] args)
        {
            // Se um valor de dinheiro for maior ou igual a 100 reais, o caixa deverá dar 1 nota de 100 reais.
            // Se for maior ou igual a 50 reais, dar uma nota de 50 reais, e assim por diante progama
